...
$result= mysqli_query($con, "select * from events order by photoid ASC")or die('Error In Session');
...
<td style="text-align:center; word-break:break-all; width:300px;"> <?php echo $row ['event_title']; ?></td>
<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['event_description']; ?></td>
<td style="text-align:center; word-break:break-all; width:300px;"> <?php echo $row ['event_address']; ?></td>
<td style="text-align:center; word-break:break-all; width:300px;"> <?php echo $row ['event_date']; ?></td>
<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['event_time']; ?></td>
