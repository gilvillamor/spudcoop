    ...
    <section class="ftco-section contact-section ftco-degree-bg">
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="w-100"></div>
          <div class="col-md-3">
            <p><span>Address:</span>  St. Paul University Dumaguete, Bantayan, Dumaguete City</p>
          </div>
          <div class="col-md-3">
            <p><span>Contact Number:</span> (035) 420 9144</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Facebook Page:</span> <a href="https://www.facebook.com/spudmpc/">https://www.facebook.com/spudmpc/</a></p>
          </div>
